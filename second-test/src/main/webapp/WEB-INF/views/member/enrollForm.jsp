                 ...
                 <div class="login-sub-container-input">
                    <form class="login-sub-container-form" id="enrollForm" method="post" action="insert.me">
                        ...
                        <div class="checkbox-box">
                            <input type="checkbox" style="margin-left: 60px; margin-top: 15px;" required> 
                            <span>I agree to JOIN's terms and conditions as well as 
                            <br> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp    the privacy policy </span>
                        </div>
